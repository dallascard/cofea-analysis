...
def main():
    ...
    parser.add_option('--basedir', type=str, default='/data/dalc/accessible_archives/',
                      help='Base directory: default=%default')
    parser.add_option('--cofea-dir', type=str, default='/data/dalc/COFEA/',
                      help='COFEA directory: default=%default')
    ...
    for infile in files:
                ...
                if len(raw_pieces) == 0:
                    ...
                    for p_i, piece in enumerate(raw_pieces):
                        if p_i == 0:
                            ...
                            rejoined_pieces.append(piece)
                    outline = {'id': line_id}
                    for field in ['uri', 'collection', 'title', 'author', 'year', 'decade', 'genre', 'subgenre', 'lang']:
                        if field in line:
        ...
        print("Ouptut written to", outfile) 
